...
export default function EditarCidadaoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Erro ao atualizar cidadão. Tente novamente.');
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="min-h-full bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Editar Cidadão</h1>
            <p className="text-sm text-gray-500">
              Atualize as informações do cidadão
            </p>
          </div>
        </div>
