...
import { tipoOrgaoLabels } from '@/types/gabinete';
...
export default function NovoOrgaoPage() {
  ...
  const handleTipoChange = (tipo: string) => {
    ...
    setFormData({
      ...formData,
      tipo,
      esfera: (tipoInfo?.esfera as 'municipal' | 'estadual' | 'federal') || 'municipal',
    });
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Erro ao criar órgão. Tente novamente.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-full bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Novo Órgão</h1>
